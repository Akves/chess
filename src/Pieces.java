interface Pieces{
    ...
    default boolean isPositionAvailable(int row_beg, int column_beg, int row_end, int column_end, Position[][] board, boolean currentPlayer){
        boolean result = true;
        if (board[row_beg][column_beg].piece.icon != '\u2003'){
            result = true;
